{
  ...
  home-manager = {
    users.${currentSystemUser} = {
      ...
      age.secretsDir = "${config.home.homeDirectory}/.agenix/agenix";
      age.secretsMountPoint = "${config.home.homeDirectory}/.agenix/agenix.d";
      ...
      age.secrets."github-ssh-key" = {
        file = "${secrets}/systems/personal-mac-mini/github-ssh-key.age";
      };

      age.secrets."github-signing-key" = {
        file = "${secrets}/users/gustavclausen_com/github-signing-key.age";
      };
      ...
      custom.iac.enable = true;
      custom.nodejs.enable = true;
  ...
  custom.darwin.dock.enable = true;
